...
<div class="center">
	<table>
		<tr class="h hhvm">
			<td>
				<a href="http://hhvm.com/"><img border="0" alt="HHVM logo"
	...
	<table>
		<tr class="h">
			<td>
				<a href="http://www.php.net/"><img border="0" alt="PHP logo"
	...
	<table>
		...
		<tr><td class="e">USER </td><td class="v"><?= get_current_user() ?></td></tr>
		<tr><td class="e">HOME </td><td class="v"><?= $_SERVER['DOCUMENT_ROOT'] ?></td></tr>
	</table>
	<h2>PHP Variables</h2>
	<?php
	...
	<h1>HHVM Credits</h1>
	<table>
		<tr class="h"><th>Contributing</th></tr>
		<tr><td class="e">
	...
	<table>
		<tr class="v"><td>
			...
			<p>The Hack typechecker (hphp/hack) is licensed under the BSD license (hphp/hack/LICENSE) with an additional grant of patent rights (hphp/hack/PATENTS) except as otherwise noted.
			</p>
		</td></tr>
	</table>
</div>
...
function print_extension_table($array) {
	...
	foreach ($array as $key => $value) {
		echo '<h2>' . $value . '</h2>';
		echo '<table border="0" cellpadding="3">';
		echo '<tr><td class="e">', ucwords(str_replace('_', ' ', $value)), ' support</td><td class="v">enabled</td></tr>';
		echo '</table>';
	}
}
